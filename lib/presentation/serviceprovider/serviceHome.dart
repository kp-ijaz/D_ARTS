...
class ServiceHome extends StatelessWidget {
  final CaptionController captionController = Get.put(CaptionController());
  ...
  Widget _buildCaption(String username, String caption) {
    ...
    if (!captionController.isExpanded.value && caption.length > 100) {
